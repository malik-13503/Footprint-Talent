...
import { PersonalInfo, ProfessionalDetails, DocumentUpload } from "@shared/schema";
...
export default function Register() {
  ...
  const renderStepContent = () => {
    switch (currentStep) {
      case 1:
        return <PersonalInfoForm onSubmit={handlePersonalInfoSubmit} defaultValues={personalInfo} />;
      case 2:
        return (
  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="fixed inset-0" style={{backgroundImage: 'var(--noise-texture)', opacity: 0.3, mixBlendMode: 'overlay', zIndex: -9}}></div>
      ...
      <header className="bg-gradient-to-r from-[#262626] to-[#262626] py-6 px-6 shadow-xl relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between relative z-10">
          <div className="flex items-center space-x-4">
            <div className="bg-[#FF6713]/10 backdrop-blur-sm p-2 rounded-xl">
              <img src={logoPath} alt="Footprint Advertising Solutions LLC Logo" className="h-12 w-auto" />
            </div>
            <div className="flex flex-col">
              <h1 className="text-3xl font-medium text-white tracking-tight">
                <span className="text-white">Footprint</span>
                <span className="text-[#FF6713]"> Advertising</span>
                <span className="text-white"> Solutions</span>
                <span className="text-[#FF6713]"> LLC</span>
              </h1>
              <span className="text-sm text-white/80 font-light tracking-wide">Connecting exceptional talent with premier brands worldwide</span>
            </div>
          </div>
          <div className="flex items-center space-x-4">
        ...
        <div className="mb-8 sm:mb-12 text-center">
          ...
          <p className="text-[#262626] text-base sm:text-lg md:text-xl max-w-2xl mx-auto font-light leading-relaxed px-2">
            <span className="relative inline-block">
              <span className="relative z-10">Handpicked talent. Iconic brands. Exceptional experiences.</span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="flex flex-col md:flex-row justify-between items-center border-b border-white/10 pb-8 mb-8">
            <div className="flex items-center mb-4 md:mb-0">
              <div className="bg-[#FF6713]/10 backdrop-blur-sm p-3 rounded-xl mr-4">
                <img src={logoPath} alt="Footprint Advertising Solutions LLC Logo" className="h-10 w-auto" />
              </div>
              <div>
                ...
                <p className="text-gray-400 text-sm mt-1 font-light">Creating powerful brand impressions through exceptional talent</p>
              </div>
            </div>
          ...
          <div className="text-center">
            <p className="text-gray-400 text-sm font-light">
              &copy; {new Date().getFullYear()} Footprint Advertising Solutions LLC. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
