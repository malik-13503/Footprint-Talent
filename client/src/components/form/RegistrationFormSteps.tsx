...
export function RegistrationFormSteps({ currentStep }: RegistrationFormStepsProps) {
  return (
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex flex-col items-center relative group">
          ...
          <div className={cn(
            ...
            <span className="text-[10px] sm:text-xs md:text-sm">Pro</span>
          </div>
        </div>
        ...
        <div className="flex flex-col items-center relative group">
          ...
          <div className={cn(
            ...
            <span className="text-[10px] sm:text-xs md:text-sm">Docs</span>
          </div>
        </div>
        ...
        <div className="flex flex-col items-center relative group">
          ...
          <div className={cn(
            ...
            <span className="text-[10px] sm:text-xs md:text-sm">Review</span>
          </div>
        </div>
      </div>
    </div>
