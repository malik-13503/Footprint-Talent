      ...
      <div className="p-6 space-y-6">
          ...
          <CardContent>
            <dl className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-2 mb-4">
              ...
              <div>
                ...
                <dd className="text-sm text-gray-900">{professionalDetails.height} cm</dd>
              </div>
              <div>
                <dt className="text-sm font-medium text-gray-500">T-Shirt Size</dt>
                <dd className="text-sm text-gray-900 uppercase">{professionalDetails.tShirtSize}</dd>
              </div>
              <div>
                <dt className="text-sm font-medium text-gray-500">Shirt Size</dt>
                <dd className="text-sm text-gray-900 uppercase">{professionalDetails.shirtSize}</dd>
              </div>
            </dl>
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="space-y-1">
                  {documents
                    .filter(doc => ["passport", "visa", "emiratesId"].includes(doc.type))
        ...
        <div className="flex flex-col sm:flex-row justify-between pt-6 sm:pt-8 space-y-4 sm:space-y-0">
          ...
          <Button
            ...
            className={`group relative px-5 sm:px-8 py-3 sm:py-5 text-sm ${isSubmitting ? 'bg-gray-400' : 'bg-gradient-to-r from-purple-600 to-primary hover:from-primary hover:to-purple-600'} transition-all duration-300 text-white shadow-md hover:shadow-lg hover:scale-[1.03] min-w-[150px] sm:min-w-[180px] animate-shimmer`}
          >
